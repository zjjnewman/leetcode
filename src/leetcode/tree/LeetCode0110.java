...
// Utility class to store information from recursive calls
    ...
    class Solution2 {
        // Return whether or not the leetcode.tree at root is balanced while also storing
        // the leetcode.tree's height in a reference variable.
        private TreeInfo isBalancedTreeHelper(TreeNode root) {
            // An empty leetcode.tree is balanced and has height = -1
            if (root == null) {
